  ...
  callWithJQuery(function($) {
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        uiTable = $("<div>", {
          "class": "pvtUi row pl-3 pr-1"
        });
        rendererControl = $("<td>").addClass("pvtUiCell");
        renderer = $("<select>").addClass('pvtRenderer form-control').bind("change", function() {
          return refresh();
        });
        ref = opts.renderers;
        for (x in ref) {
        ...
        unused = $('<div>').addClass('pvtAxisContainer pvtUnused pvtUiCell col-md-6');
        ...
        unused.append('<h3><i class="fa fa-table"></i> Campos de tabla</h3>');
        fn1 = function(attr) {
        ...
        tr1 = uiTable;
        aggregator = $("<select>").addClass('pvtAggregator form-control').bind("change", function() {
          return refresh();
        });
        ...
        rowOrderArrow = $('<a title="Ordenar Filas">', {
          role: "button"
        ...
        colOrderArrow = $('<a title="Ordenar Columnas">', {
          role: "button"
        ...
        col += '<div class="col-md-6">';
            col += '<div class="row pl-1 pr-1">';
                col += '<div class="pvtVals pvtUiCell col-md-12">';
                    col += '<h3 class="text-left"><i class="fa fa-calculator"></i> Valores</h3>';
                col += '</div>';
                col += '<div class="pvtAxisContainer pvtHorizList pvtCols pvtUiCell col-md-12 mt-2">';
                    col += '<h3 class="titleFilas"><i class="fa fa-columns"></i> Filas</h3>';
                col += '</div>';
                col += '<div class="pvtAxisContainer pvtRows pvtUiCell col-md-12 mt-2">';
                    col += '<h3 class="titleColumnas"><i class="fa fa-columns fa-rotate-270"></i> Columnas</h3>';
                col += '</div>';
            col += '</div>';
        col += '</div>';
        
        $('<div>').addClass('col-md-4 pvtFiltersArea').html('<div class="row"></div>').appendTo(tr1);
        pivotTable = $('<div>').addClass('col-md-8 pvtRendererArea table-responsive').appendTo(tr1);
        if (opts.unusedAttrsVertical === true || unusedAttrsVerticalAutoOverride) {
            // uiTable.find('tr:nth-child(1)').prepend(rendererControl);
            //uiTable.find('tr:nth-child(1)').prepend(unused);
            uiTable.find('.pvtFiltersArea').find('div').append(unused);
        } else {
          // uiTable.prepend($("<tr>").append(rendererControl).append(unused));
        }
        uiTable.find('.pvtFiltersArea').find('div.row').append(col);
        uiTable.find('.pvtFiltersArea').find(".pvtVals").append(renderer).append(aggregator);
        uiTable.find('.pvtFiltersArea').find(".titleFilas").append(rowOrderArrow);
        uiTable.find('.pvtFiltersArea').find(".titleColumnas").append(colOrderArrow);
          ...
          return function() {
            ...
            if (numInputsToProcess !== 0) {
              ...
              for (x = t = 0, ref5 = numInputsToProcess; 0 <= ref5 ? t < ref5 : t > ref5; x = 0 <= ref5 ? ++t : --t) {
                newDropdown = $("<select>").addClass('pvtAttrDropdown form-control').append($("<option>")).bind("change", function() {
                  return refresh();
                });
