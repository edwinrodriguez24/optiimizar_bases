...
<html>
    ...
    <body>
        <div style="text-align: center;">
            <form action="/optiimizar_bases/query.php" method="post">
        ...
        if (!empty($consqlSelect)):
            ...
            try {
                ...
                <?php foreach ($arrayDatos as $key => $array): ?>
                        <?php if ($key === 0): ?>
                            <tr>
                            <?= '<td style="width:100px; text-align: center; background-color: #f0f0f0;  padding: 8px;">' . implode('</td><td style="width:100px; text-align: center; background-color: #f0f0f0; padding: 8px;">', array_keys($array)) . '</td></tr>' ?>
                            </tr>
                            <?php endif; ?>
                        <tr>
